  ...
  return (
    <header className="flex justify-between items-center px-6 py-4 backdrop-blur-lg shadow-md">
      ...
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button
            className="flex items-center space-x-3 rounded-full focus:outline-none focus:ring-2 
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    onClick={goToProfile}
                    className={
                      "group flex w-full items-center rounded-md px-2 py-2 text-sm hover:bg-blue-300"
                    }
                  >
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    className={
                      "group flex w-full items-center rounded-md px-2 py-2 text-sm hover:bg-red-300"
                    }
                  >
